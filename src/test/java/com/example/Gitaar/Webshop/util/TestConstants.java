package com.example.Gitaar.Webshop.util;
...
public class TestConstants {
    ...
    public static final String CREATOR_CREED = "Creed";
    public static final String CREATOR_CHANEL = "Chanel";
    public static final String CREATOR_TITLE = "Chanel N5";
    public static final Integer YEAR = 1921;
    public static final String COUNTRY = "France";
    public static final String FRAGRANCE_TOP_NOTES = "";
    public static final String FRAGRANCE_MIDDLE_NOTES = "";
    public static final String FRAGRANCE_BASE_NOTES = "";
    ...
    public static final String GRAPHQL_QUERY_PRODUCTS = "" +
            "{\n" +
            "    products {\n" +
            "        id\n" +
            "        productTitle\n" +
    ...
    public static final String GRAPHQL_QUERY_PRODUCT = "" +
            "{\n" +
            "    product(id: 2) {\n" +
            "        id\n" +
            "        productTitle\n" +
