...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(PasswordConfigException.class)
    public ResponseEntity<PasswordConfigException> handlePasswordConfirmationException
            (PasswordConfigException exception) {
        return ResponseEntity.badRequest().body(new PasswordConfigException(exception.getPassword2Error()));
    }
